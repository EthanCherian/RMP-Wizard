function loadRatingsInfo() {  
    ...
    $(document).ready(function() {
        ...
        var getScript = document.querySelector('#bx-tag');
        //fix this bad-coding
        var clientCall = getScript.nextElementSibling.nextElementSibling.nextElementSibling;
                    ...
                    success: function(response) {
                        ...
                        */
                        ...
                        for(var i = sentiments[0].length-1; i >= 0; i--) {
                            ...
                            if(maxYear - thisYear > numYearsDisplay)
                                break;
                    ...
                    if(getLine != null && checkSentiment == null) {
                        ...
                        if(rating > 3.3) {
                            ...
                            if(sentiments[0][sentimentsCounter] == 'Negative')
                                getBoxes[i].style.border = "solid #ffff00";
                            else
                                getBoxes[i].style.border = "solid #00ff00";
                        ...
                        //types of ratings.
                            ...
                            if(sentiments[0][sentimentsCounter] == 'Positive')
                                ...
                                getBoxes[i].style.border = "solid #ff0000";
