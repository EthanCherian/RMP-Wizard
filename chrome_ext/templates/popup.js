...
function setPredictions() {
    ...
    for(var i = 0; i < els.length; i++) {
        ...
        var checkSentiment = els[i].querySelector('#insertedSentiment');
        // console.log("checkSentiment" + checkSentiment);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for(var i = 0; i < els.length; i++) {
                    ...
                    var checkSentiment = els[i].querySelector('#insertedSentiment');
                    if(getLine != null && checkSentiment == null) {
                        els[i].insertAdjacentHTML("afterbegin", '<h2 id="insertedSentiment"><strong>' + sentiments[sentimentsCounter++] + '</strong></h2>');
                        // console.log("here");
                    }
